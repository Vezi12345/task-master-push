...
class GreenhouseBrowserAdapter(BrowserAdapter):
    name = "greenhouse"
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                inputs = await page.query_selector_all(
                    ...
                    "#application_form textarea, .field input, .field select, .field textarea"
                )
                for inp in inputs:
    ...
    async def fill_and_submit(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                return BrowserResult(
                    success=False,
                    error="No submit button found on Greenhouse page",
                    requires_human_input=True,
                )
            except Exception as exc:
                return BrowserResult(
                    success=False,
                    error=f"Greenhouse browser error: {exc}",
                    requires_human_input=True,
                )
            finally:
                await browser.close()
